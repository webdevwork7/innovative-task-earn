...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/reactivation/initiate", async (req, res) => {
    ...
    if (process.env.NODE_ENV === "development") {
      console.log(
        `Development mode: Simulating reactivation payment for ${email}`
      );
      ...
      res.json({
        ...
        devMode: true,
        message:
          "Development mode: Click the payment URL to simulate successful payment",
      });
    } else {
  ...
  app.post("/api/reactivation/verify", async (req, res) => {
    ...
    try {
      ...
      if (process.env.NODE_ENV === "development") {
        console.log(
          `Development mode: Simulating successful reactivation for ${email}`
        );
        res.json({
          success: true,
  ...
  app.post("/api/admin/tasks", (req, res) => {
    ...
    const { title, category, description, reward, timeLimit, requirements } =
      req.body;
    ...
    const adminTasks = [
      {
        ...
        category: "app_download",
        description:
          "Download and install the Amazon Shopping app, take a screenshot of the installed app on your home screen",
        reward: 15,
        timeLimit: 20,
        status: "active",
        completions: 234,
      ...
      },
      {
        ...
        category: "business_review",
        description:
          "Write a genuine review for a local restaurant on Google Maps with at least 100 words",
        reward: 20,
        timeLimit: 30,
        status: "active",
        completions: 156,
      ...
      },
      {
        ...
        category: "channel_subscribe",
        description:
          "Subscribe to specified tech YouTube channel and provide screenshot of subscription confirmation",
        reward: 10,
        timeLimit: 15,
        status: "active",
        completions: 445,
      ...
      },
      {
        ...
        category: "product_review",
        description:
          "Write a detailed product review on specified e-commerce platform with photos",
        reward: 25,
        timeLimit: 45,
        status: "active",
        completions: 89,
      ...
      },
      {
        ...
        category: "comment_like",
        description:
          "Like and comment meaningfully on specified social media posts",
        reward: 8,
        timeLimit: 10,
        status: "active",
        completions: 567,
      ...
      },
      {
        ...
        category: "youtube_video_see",
        description:
          "Watch full video, like, and share on your social media with meaningful caption",
        reward: 12,
        timeLimit: 20,
        status: "active",
        completions: 323,
  ...
  app.post(
    "/api/admin/tasks/:taskId/submissions/:submissionId/approve",
    (req, res) => {
      if ((req.session as any)?.role !== "admin") {
        return res.status(403).json({ error: "Admin access required" });
      }
  ...
  app.post(
    "/api/admin/tasks/:taskId/submissions/:submissionId/reject",
    (req, res) => {
      if ((req.session as any)?.role !== "admin") {
        return res.status(403).json({ error: "Admin access required" });
      }
        ...
        messages: [
          {
            sender: "John Doe",
            message:
              "I have ₹1500 in my account but the withdrawal option is disabled.",
          ...
          },
          {
            ...
            message:
              "Let me check your account status. Can you confirm if your KYC is verified?",
        ...
        messages: [
          {
            sender: "Jane Smith",
            message:
              "I completed a product review task yesterday but it's still pending approval.",
  ...
  app.get("/api/user/dashboard", (req, res) => {
    ...
    const dashboardData = {
      ...
      notifications: [
        {
          id: 1,
          message: "Task submission approved - ₹25 credited",
          type: "success",
          read: false,
        },
        {
          id: 2,
          message: "New task available: Restaurant Review",
          type: "info",
          read: true,
        },
        {
          id: 3,
          message: "Withdrawal of ₹500 processed successfully",
          type: "success",
          read: true,
        },
      ],
  ...
  app.get("/api/user/profile", (req, res) => {
    ...
    const profileData = {
      ...
      recentActivity: [
        {
          type: "task_completed",
          description: "Product Review task completed",
          date: "2024-08-16",
          amount: 25,
        },
        {
          type: "earning_credited",
          description: "App Download reward credited",
          date: "2024-08-15",
          amount: 15,
        },
        {
          type: "withdrawal_approved",
          description: "Withdrawal of ₹500 approved",
          date: "2024-08-15",
          amount: -500,
        },
      ],
        ...
        messages: [
          {
            sender: "Demo User",
            message:
              "How long does it take for task submissions to be approved?",
          ...
          },
          {
            sender: "Support Team",
            message:
              "Task submissions are typically reviewed within 5-20 minutes during business hours.",
    ...
    const notifications = [
      {
        ...
        title: "Task Approved",
        message:
          "Your Product Review task has been approved. ₹25 credited to your account.",
        type: "success",
        read: false,
      ...
      },
      {
        ...
        message:
          "Your withdrawal request of ₹500 has been successfully processed.",
        type: "success",
        read: true,
